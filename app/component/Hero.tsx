...
function Hero() {
    return (
        <div className="w-full max-h-fit ">
            ...
            2xl:bg-[url('/finaltvlines.svg')] 2xl:mx-[150px]"
            >
                <Logo />
                <div className="mx-4 pt-4 md:pt-6  ">
                    ...
                    <div className="sm:mx-10">
                        <h1 className="text-4xl md:leading-tight md:text-7xl lg:leading-[1.2] lg:text-7xl lg:mx-16 xl:mx-20 font-medium text-center bg-gradient-to-r from-[#94959C] via-[#FFFFFF] to-[#93949B] text-transparent bg-clip-text ">
                            The next-evolution in data storage is here
                        </h1>
                        <p className="text-base text-[#B6B6B8] text-center mt-5  font-light md:my-10 2xl:mt-10">
